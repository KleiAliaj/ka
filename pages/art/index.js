              ...
              <MotionText>
                <div className="text-box">
                  ...
                  <p className="font-bold">
                    ...
                    back in 2019. I make primarily LoFi hip hop beats, the type
                    of music you&apos;d want to hear on a moody rainy day. Music
                    is an incredible medium for expressing emotions, I can still
                    remember the way I was feeling when I listen to any of my
                    old tracks. Something about a blank musical canvas and a
                    keyboard makes my soul really happy.
                    <br />
                    <br />
                    It&apos;s certainly not perfect, but I&apos;m proud of how
                    it turned out. Creativity isn&apos;t about perfection,
                    it&apos;s about expressing who you are through a medium you
                    enjoy. Give it a listen, and{" "}
              ...
              <MotionText invert>
                <div className="text-box">
                  ...
                  <p className="font-bold">
                    ...
                    canvas. I have so much fun tweaking algorithms to create a
                    set of pixels that looks pleasing to my eye.
                    <br />
                    <br />I learned how to code through art, and in a way,
                    learned art through code. Check out my generative art
                    pieces, not all of them made it to the website, but my
                    favorites are there to be played with, or remixed and made
                    your own!
                  </p>
                </div>
              </MotionText>
              ...
              <MotionText>
                <div className="text-box !shadow-blue-400/40">
                  ...
                  <p className="font-bold">
                    ...
                    restrained by my drawing skills, the only limit to what can
                    be created is my own imagination. What a time to be alive!
                    <br />
            ...
            <TextSection>
              ...
              <MotionText invert>
                <div className="text-box !shadow-violet-400/40">
                  ...
                  <p>
                    Photography might be my most &quot;productive&quot; hobby,
                    it gets me outdoors, keeps me active, and has massively
                    improved my creativity in general. Thanks to photography, I
                    see the world through a whole new lens (
                    <span className="italic">pun intended</span>). I find myself
                    noticing things in my daily life that I would have
                    overlooked otherwise. Now, a bee on a flower will make pause
                    for a second; to appreciate the beauty in the tiny things,
                    but also to say,{" "}
