      ...
      >
        ...
        <div className="flex flex-col items-center text-box !px-10 mt-4">
          ...
          <p>
            ...
            framework. I was six months into my dev journey, and it&apos;s safe
            to say I bit off more than I could chew, but I kept at it and ended
            up building the entire codebase myself. I started off using only
            create-react-app, but I quickly discovered that I would need a
            backend to send API requests to. This lead me to convert my entire
            project to a Next.js app and learn that as I went as well. As the
            complexity grew, as did my need for a global state manager, so I did
            a crash course in Redux and added Redux state management to the
            project. I then implemented Firebase authentication and a Firestore
            NoSQL database for user accounts and data. It was surprisingly easy
            to learn Firebase, but hard to master the intricacies down the road.
            I converted to Tailwind CSS halfway through my project, so I had a
            large CSS file and Tailwind on the same project (don&apos;t worry,
            I&apos;ll showcase ALL of my mistakes at the end of this).
          </p>
          ...
          <p>
            ...
            work, 6 days a week minimum. Non-stop coding for five months
            straight. I&apos;m skipping a lot of details here of specific
            implementations, I could write a book on everything that I did for
            this project, but you get the idea. At the end of the five-month
            period, I had a working app! It worked well, loaded quickly, was
            secure, and had an array of features. It was well and truly, a full
            stack Next.js SAAS app built from scratch with my own hands. I was
            super proud of it and excited to show it off to potential customers.
            (Yup, we made the mistake of building the entire app before
            validating the idea or getting customer feedback, oops.)
          </p>
          <br />
          <p>
            ...
            wasn&apos;t the app, it was the underlying problem we were trying to
            solve. I had meetings with a few entrepreneurs and asked them
            ...
            That&apos;s a tough niche to market to, and even tougher to convince
            those folks to pay a monthly subscription fee for a tool that could
            * potentially * help them create an idea. After five months of
            development, it took less than a week to learn that the idea for an
            idea maker was weak, and not worth pursuing. Ouch.
          </p>
          <br />
          <p>
            ...
            before building. Never again will I build business apps blindly, and
            I intend to never go at it fully alone again. Knowing what I know
            now, I could build a similar app in a fraction of the time, and that
            knowledge gained was worth the price of admission, but barely lol.
          </p>
          <br />
          <div className="w-full">
            {" "}
          ...
          <ul className="ml-8 space-y-2 list-disc">
            ...
            <li>
              <p>
                ...
                some example projects first, then gone on to learn Next.js, then
                built out the app. Learning them both at the same time
            ...
            <li>
              <p>
                ...
                was working just fine with regular CSS classes added unnecessary
            ...
            <li>
              <p>
                ...
                sheer size of some of the components. If I had to jump in and
                fix something in that file I would have no idea where to start.
              </p>
            </li>
            ...
            <li>
              <p>
                ...
                idea. You can always access old code from old commits,
                that&apos;s where it belongs. Not grayed out next to functioning
                code.
              </p>
            </li>
            ...
            <li>
              <p>
                ...
                colors to make it “perfect”. Perfect UI&apos;s don&apos;t exist.
                Get it 80% of the way there, and come back to it later if you
                have to. Even big sites like Apple.com have tiny imperfections.
              </p>
            </li>
            <li>
              <p>
              ...
              <ol className="ml-6 font-bold list-decimal f2 text-sky-600 dark:text-sky-200">
                ...
                <li>
                  ...
                  <p>
                    ...
                    for their idea and rank these features in an interactive
                    table UI
                  </p>
                </li>
                <li>
