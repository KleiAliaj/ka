      ...
      >
        ...
        <div className="flex flex-col items-center mb-2 text-box">
          <p>
            ...
            MidJourney, I noticed that I was having image prompt writers block.
            The AI could make <strong>anything</strong> you wanted, and that
            lead me to analysis paralysis, so I would just write whatever came
            to my mind. After a few off the top prompts like, &quot;A monkey on
            a spaceship painted by Picasso&quot;, I realized that I wanted to be
            more deliberate with my prompt design. Instead of just throwing
            whatever into the prompt, I wanted to plan out my prompts much like
            a professional artist would would plan an art piece. Thus, the idea
            for DeliberateDesign.art was born.
          </p>
        </div>
                ...
                <div className="w-full">
                  ...
                  <ol className="ml-6 font-bold list-decimal f2 text-sky-600 dark:text-sky-200">
                    ...
                    <li>
                      ...
                      good, it gets the job done, but Recoil makes global state
                      so much easier.
                    </li>
                    <li>
                      Next.js is my true love. I have enough experience with it
                      now to take full advantage of its features and bend it to
                      my will.
                    </li>
                    <li>
                    ...
                    <li>
                      I wrote what felt like a million array.map()&apos;s, what
                      a powerful tool to build numerous UI components from a
                      single array in React.
                    </li>
                  </ol>
                </div>
              </div>
