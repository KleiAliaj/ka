      ...
      >
        ...
        <div className="flex flex-col items-center mb-2 text-box">
          <p>
            ...
            that don&apos;t really belong together. This was a great way to make
            wild ideas that I never would have come up with otherwise, so I
            decided to make a simple web app that displayed each row of the
            ...
            randomly select a word from the array and display it to the screen.
            <br />
            <br />
            This was my first real &quot;web app&quot;, and I learned a lot
            about JS, CSS, and the DOM. I was super proud of my creation at the
            time, even though it took longer than I&apos;d like to admit lol. It
            was the seed for the idea that would become ideaisland several
            months later. In hindsight, before turning it into a larger
            application, I should have shared this tool with others to see if
            they found value in it, in which I would have discovered that making
            ideas without a defined problem was a lousy way to innovate. You
            live and you learn though right? 🤷‍♂️
          </p>
        </div>
              ...
              <div className="flex flex-row-reverse lg:flex-col">
                ...
                <div className="w-full">
                  ...
                  <ol className="ml-6 font-bold list-decimal f2 text-sky-600 dark:text-sky-200">
                    ...
                    <li>
                      Although its fun making ideas with this platform, the best
                      way to make innovations that are useful is to find actual
                      problems in the world, then find solutions to them. Making
                      random solutions without first having a real problem is a
                      recipe for disaster.
                    </li>
                  </ol>
                </div>
