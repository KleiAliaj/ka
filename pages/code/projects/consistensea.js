      ...
      >
        ...
        <div className="flex flex-col items-center mb-2 text-box">
          <p>
            ...
            that I would actually remember to use, so I decided to make a new
            tab chrome extension so that I would see my habits on every single
            new tab. Turns out React plays well with chrome extensions, and
            there is so much you can do with the Chrome Extension API. Framer
            Motion is so fun to use, and brings life into an otherwise static
            site! This project took me about a week to build. I launched it on
            ProductHunt, and learned a lot from the process of launching a
            product!
          </p>
        </div>
