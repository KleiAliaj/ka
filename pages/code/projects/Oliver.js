      ...
      >
        ...
        <div className="flex flex-col items-center mb-2 text-box">
          <p>
            ...
            thought it would be so cool if I could ask it for life advice. I
            ...
            and added a drop down menu to change the &quot;proffession&quot; of
            Oliver. This will not be my last GPT-3 project, especially now that
            I have boilerplate code for it.
          </p>
        </div>
                ...
                <div className="w-full">
                  ...
                  <ol className="ml-6 font-bold list-decimal f2 text-sky-600 dark:text-sky-200">
                    <li>
                      ...
                      providing life advice of all sorts. I was blown away with
                      the results after a few days of tweaking prompts.
                    </li>
                    <li>
                      CSS animations are so fun! It was really enjoyable getting
                      the mouth to &quot;talk&quot; and to get the eyes to
                      blink.
                    </li>
                    <li>
