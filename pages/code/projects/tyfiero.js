      ...
      >
        ...
        <div className="flex flex-col items-center mb-6 text-box">
          <p>
            ...
            about what tech stack I would use for this project, I decided to
            work backwards from what I needed the site to do. It needed to be
            ...
            experience working with a content management system (CMS) in React,
            so I decided on Cosmic CMS mostly due to the low cost and easy to
            understand API. For styling I went with Tailwind because I love
            tailwind, but also because it would speed up the site by shipping
            less CSS to the browser.
            <br />
            <br />
            The bones for this project took me about a week to build, but I have
            been iterating on the site ever since. Having a central hub to put
            all of my content and projects has been a game changer, it motivates
            me to continue to create and share who I am with the world. I plan
            on implementing a full 3D landing page experience with React Three
            Fiber soon, to give the site more of a wow factor while hopefully
            keeping loading times fast.
            <br />
            <br />
              ...
              <div className="flex flex-row-reverse lg:flex-col">
                ...
                <div className="w-full">
                  ...
                  <ol className="ml-6 font-bold list-decimal f2 ">
                    ...
                    <li>
                      <p>
                        Airtable as an backend API for serving my AI artwork and
                        my favorite links (although in the future I
                ...
                <div className="w-full">
                  ...
                  <ol className="ml-6 font-bold list-decimal f2 text-sky-600 dark:text-sky-200">
                    ...
                    <li>
                      Using the Unsplash API to load all images from my account
                      as well as the real-time stats.
                    </li>
                    <li>
